...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (addLinkBtn && linksContainer) {
        addLinkBtn.addEventListener("click", () => {
            ...
            row.innerHTML = `
                <select class="flex-shrink-0 h-10 px-3 pr-8 rounded-xl border border-outline-variant hover:border-primary bg-surface-container-low hover:bg-[#f8faff] text-on-surface text-sm cursor-pointer transition-all shadow-2xs">
